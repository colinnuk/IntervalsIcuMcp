...
{
    private static readonly string DefaultSystemPrompt = @"You are an expert endurance sports coach with deep knowledge of periodization, training science, and athlete recovery. 
        ...
        Ensure that insights are research backed and evidence based.
    ...
    public static IEnumerable<ChatMessage> AnalyzeFitnessStatus(
        [Description("Number of days to look back (default: 42)")] int daysBehind = 42)
    {
        ...
        return [new ChatMessage(ChatRole.System, DefaultSystemPrompt), new ChatMessage(ChatRole.User, userMessage)];
    }
    ...
    public static IEnumerable<ChatMessage> PlanEnduranceTrainingBlock(
    ...
    public static IEnumerable<ChatMessage> StrengthTrainingRecommendations(
    ...
    public static IEnumerable<ChatMessage> RacePreparationPlan(
    ...
    public static IEnumerable<ChatMessage> RecoveryAndOverttrappingAssessment(
    ...
    public static IEnumerable<ChatMessage> CrossTrainingSuggestions(
        [Description("Primary sport (cycling or running)")] string primarySport,
    ...
    public static IEnumerable<ChatMessage> WinterBaseBuilding()
    {
